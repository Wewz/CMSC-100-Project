...
Log In - Upon clicking the log-in button, a pop-up window will appear with two fields to fill up, the username and password. After filling up the two fields, click log in. It will then find a match of the username and password from the database. If the username and password are found, the user will be transferred to the customer view page, if not found, it will inform the user that the login failed. 
...
Checkout - Check out all the items in the basket. All of them will be added to the pending transactions and will wait for the approval of the admin. 

![React App (10)](https://github.com/rdnieto/proj100/assets/135321933/7a507381-c505-4957-b3c5-d86f0266bd50)


Sort Products - Sort all the displayed products by type, quantity, or name in either ascending or descending order.
...
Managing all transactions of the user - All transactions of the currently signed-in user can be managed on this page. Pending transactions can also be canceled. 
![React App (12)](https://github.com/rdnieto/proj100/assets/135321933/77ff262b-2ea9-438e-be14-bfae105df763)

Log out - Log out the currently signed-in user and return to the homepage. 
...
Manage users - All registered users on the website can be managed here. 
![React App (22)](https://github.com/rdnieto/proj100/assets/135321933/044bdc4c-e8f6-49ad-9916-889a24366015)

Manage products - All existing products on the website can be managed here. The admin can also add new products, edit existing products, and delete products. 
...
View sales report - The overall sales report as well as the sales report of each product can be seen here. All the approved transactions can also be seen here. 
