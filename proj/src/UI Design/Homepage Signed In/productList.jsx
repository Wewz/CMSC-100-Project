                ...
                <div className="w-[80%] mt-12 mb-24 flex">
                    ...
                    <div className="w-[30%]">
                        ...
                        <div className="border border-[#2D4944] rounded-3xl p-6 w-full text-[#2D4944] flex flex-col">
                            ...
                            <button className="bg-[#2D4944] h-12 w-full mt-4 text-white rounded-lg px-6 p-2 hover:bg-[#DCE0DC] hover:text-[#2D4944] flex justify-between content-center items-center" onClick={handleOnSubmit}>
                                Continue To Payment
                                <FaArrowRightLong size={15} />
                            </button>
                        </div>
