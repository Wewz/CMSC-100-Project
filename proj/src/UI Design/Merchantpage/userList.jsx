  ...
  return (
    <div className="flex w-[80%] flex-col p-28">
        <div className="flex items-center border-b border-[#2D4944] border-opacity-40 mb-14">
            <h1 className="text-[#a2a2a2] p-4 font-bold text-3xl">User List</h1>
        </div>
                            ...
                            <div className="flex flex-col text-[#2D4944] pt-4 items-center justify-center">
                                ...
                                <div className="flex justify-between items-center">
                                    <div className="flex flex-col gap-1 p-4 truncate text-[#2D4944]">
                                        <p className="text-sm truncate ">Username: {user.username}</p>
                                        <p className="text-sm truncate ">Password: {user.password}</p>
                                        <p className="text-sm truncate">Name: {user.fname} {user.lname}</p>
                                        <p className="text-sm truncate">Phone: {user.phone}</p>
