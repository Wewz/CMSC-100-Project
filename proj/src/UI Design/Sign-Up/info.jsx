    ...
    return(
        <div className="w-full">
            ...
            <div className="hidden xl:flex 2xl:flex flex-col">
                ...
                <input type="text" className="bg-white border mt-10 border-[#2D4944] text-[#2D4944] text-m rounded-full
                ...
                <input type="text" className="bg-white mt-6 border border-[#2D4944] text-[#2D4944] text-m rounded-full
                        h-14 px-8 focus:border-[#507c74] w-full" 
                ...
                <div className="mt-6 text-left" >
                    ...
                    <input type="date" id="Bday_1" className="bg-white border border-[#2D4944] text-[#2D4944] text-m rounded-full
                        h-14 px-8 focus:border-[#507c74] w-full" 
                        placeholder="Birthday" required value={bday} onChange={(e) => setUser({ ...user, bday:e.target.value})} />
                </div>

                <input type="tel" className="bg-white border mt-6 border-[#2D4944] text-[#2D4944] text-m rounded-full
                        h-14 px-8 focus:border-[#507c74] w-full" 
            ...
            <div className="hidden lg:flex xl:hidden 2xl:hidden flex-col">
                ...
                <div className="mt-6 text-left" >
                    ...
                    <input type="date" id="Birthday_2" className="bg-white border border-[#2D4944] text-[#2D4944] text-[12px] rounded-full
                        h-14 px-8 focus:border-[#507c74] w-full" 
                        placeholder="Birthday" required value={bday} onChange={(e) => setUser({ ...user, bday:e.target.value})} />
                </div>

                <input type="tel" className="bg-white border mt-6 border-[#2D4944] text-[#2D4944] text-[12px] rounded-full
                        h-14 px-8 focus:border-[#507c74] w-full" 
                    placeholder="Phone Number" required value={phone} onChange={(e) => setUser({ ...user, phone:e.target.value})} />
            </div>
            ...
            <div className="sm:flex md:flex lg:hidden xl:hidden 2xl:hidden flex-col">
                ...
                <div className="mt-6 text-left" >
                    <label className="ml-6 text-[12px] text-[#9c9d9c] font-normal" >Birthday</label>
                    <input type="date" className="bg-white border border-[#2D4944] text-[#2D4944] text-[13px] rounded-full
                        h-14 px-8 focus:border-[#507c74] w-full" 
                        placeholder="Birthday" required value={bday} onChange={(e) => setUser({ ...user, bday:e.target.value})} />
                </div>

                <input type="tel" className="bg-white border mt-6 border-[#2D4944] text-[#2D4944] text-[13px] rounded-full
                        h-14 px-8 focus:border-[#507c74] w-full" 
                    placeholder="Phone Number" required value={phone} onChange={(e) => setUser({ ...user, phone:e.target.value})} />
            </div>
